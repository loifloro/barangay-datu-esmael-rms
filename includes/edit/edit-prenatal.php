<main class="edit-prenatal">
    <section class="form" id='personal'>
        ...
        <form action="includes/edit_query.php" method='POST' class="edit-prenatal__form" onsubmit="return validateForm()">
            <?php
            if (isset($_GET['id'])) {
            ...
            ?>
                    ...
                    <div class="edit-prenatal__form-item">
                        <label for="prenatal-preterm">Preterm *</label>
                    ...
                    <div class="edit-prenatal__form-item">
                        ...
                        <input type="date" name="prenatal-lmp" id="prenatal-lmp" value="<?= $patient['last_menstrual']; ?>">
                    </div>
                    <div class="edit-prenatal__form-item">
                        <label for="prenatal-edc">Expected Date of Confinement *</label>
                        <input type="date" name="prenatal-edc" id="prenatal-edc" value="<?= $patient['edc']; ?>" required>
                    </div>
                    <div class="edit-prenatal__form-item">
                    ...
                    <div class="edit-prenatal__form-btn">
                        <button type="submit" class="btn-green btn-add" name="edit_prenatal">
                            Edit
                        </button>
