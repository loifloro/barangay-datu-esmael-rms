<main class="edit-deworming">
    <section class="form" id='personal'>
        ...
        <form action="includes/edit_query.php" method='POST' class="edit-deworming__form" id='edit-deworming-form' onsubmit="return validateForm()">
            ...
            ?>
                    ...
                    <div class="edit-deworming__form-item--reason">
                        <input type="checkbox" class="edit-reason" name="edit-reason1" id="edit-reason-mispelled" value="Mispelled Name">
                        <label for="edit-reason-mispelled">Mispelled Name</label>
                    </div>
                    <div class="edit-deworming__form-item--reason">
                        <input type="checkbox" class="edit-reason" name="edit-reason2" id="edit-reason-gender" value="Incorrect Sex">
                        <label for="edit-reason-gender">Incorrect Sex</label>
                    </div>
                    <div class="edit-deworming__form-item--reason">
                        <input type="checkbox" class="edit-reason" name="edit-reason3" id="edit-reason-bdate" value="Incorrect Birthdate">
                        <label for="edit-reason-bdate">Incorrect Birthdate</label>
                    </div>
                    <div class="edit-deworming__form-item--reason">
                        <input type="checkbox" class="edit-reason" name="edit-reason4" id="edit-reason-address" value="Wrong Address">
