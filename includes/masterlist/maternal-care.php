    ...
    <div class="masterlist__table">
        ...
        ?>
                <ul class="masterlist__table__row masterlist__info" role="list">
                    ...
                    <li class="masterlist__option">
                        <form action="../includes/delete_query.php" method="GET">
                            <button type="submit" name="delete_maternal" value="<?= $patient['target_maternal_id']; ?>">
                        ...
                        <button type="button" onclick="window.location.href = `../edit/edit-maternal_care.php?id=<?= $patient['target_maternal_id']; ?>`">
            ...
            <div class="pagination">
                ...
                if ($page > 1) {
                ?>
                    <a href='maternal-care.php?page=<?php echo ($page - 1) ?>' class="pagination_previous">Previous</a>
                <?php
                }
                for ($i = 1; $i <= $total_page; $i++) {
                ?>
                    <a href='maternal-care.php?page=<?php echo $i; ?>' class="pagination_number"><?php echo $i; ?></a>
                <?php
                }
                if ($page < $total_page) {
                ?>
                    <a href='maternal-care.php.php?page=<?php echo ($page + 1) ?>' class="pagination_next">Next</a>
                <?php
                }
                //END OF PAGINATION
            } else {
