        ...
        ?>
                <ul class="masterlist__table__row masterlist__info" role="list">
                    ...
                    <li class="masterlist__option">
                        ...
                        <button type="button" onclick="window.location.href = `edit-record.php?service=childcare-female&id=<?= $patient['target_childcare_female_id']; ?>`">
            ...
            <div class="pagination">
                ...
                if ($page > 1) {
                ?>
                    <a href='masterlist.php?childhood-female&page=<?php echo ($page - 1) ?>' class="pagination_previous">Previous</a>
                <?php
                }
                for ($i = 1; $i <= $total_page; $i++) {
                ?>
                    <a href='masterlist.php?childhood-female&page=<?php echo $i; ?>' class="pagination_number"><?php echo $i; ?></a>
                <?php
                }
                if ($page < $total_page) {
                ?>
                    <a href='masterlist.php?childhood-female&page=<?php echo ($page + 1) ?>' class="pagination_next">Next</a>
                <?php
                }
                //END OF PAGINATION
            } else {
