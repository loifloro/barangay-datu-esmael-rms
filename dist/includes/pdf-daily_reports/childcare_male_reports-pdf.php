...
< !-- Maternal-care daily reports -->
    ...
    <div class="modal deworming-reports" id="childcare-male-daily-reports">
        <h4 class="consultation__report__title">City Government of Dasmariñas <br>City Health Office II </h4>
        <p class="consultation__report__city">City of Dasmariñas,
            Cavite </p>
        <h4 class="deworming-reports__title">Target Client List for Childcare Male Reports </h4>
        <div class="deworming-reports__details">
            <p class="deworming-reports__brgy">Name of Barangay: Datu Esmael </p>
            <div class="deworming-reports__date">Date: <?php echo $date; ?></div>
        </div>
        < !-- Query Start --><?php
                                ...
                                ?><p class="deworming-reports__brgy">Total No. of NHTS Patient: <span> <?php echo $row['count(*)']; ?> </span></p><?php
                                                                                                                                                }
                                                                                                                                                    ?>< !-- Query End -->
                < !-- Query Start --><?php
                                        ...
                                        while ($row = mysqli_fetch_array($result)) {
                                        ?><p class="deworming-reports__total">Total No. of NON NHTS Patient: <span> <?php echo $row['count(*)']; ?> </span></p><?php
                                                                                                                                                            }
                                                                                                                                                                ?>< !-- Query End -->
                        < !-- Query Start --><?php
                                                ...
                                                while ($row = mysqli_fetch_array($result)) {
                                                ?><p class="deworming-reports__total">Total No. of Patients: <span> <?php echo $row['count(*)']; ?> </span></p><?php
                                                                                                                                                            }
                                                                                                                                                                ?>< !-- Query End -->
                ...
                WHERE status_month_1_3='underweight' AND date_registered='$date'";
                                                                ...
                                                                ?><td><?php echo $status_month_1_3_underweight; ?></td><?php
                                                                                                                    }
                                                                                                                        ?>< !-- End Query for status_month_1_3-underweight --><?php
                                                                                                                                                                                $query = "SELECT count(*) FROM target_childcare_male 
                WHERE status_month_6_11='underweight' AND date_registered='$date'";
                                                                                                                                                                                ...
                                                                                                                                                                                ?><td><?php echo $status_month_6_11_underweight; ?></td><?php
                                                                                                                                                                                                                                    }
                                                                                                                                                                                                                                        ?>< !-- End Query for status_month_6_11-underweight --><?php
                                                                                                                                                                                                                                                                                                $query = "SELECT count(*) FROM target_childcare_male 
                ...
                WHERE status_month_1_3='stunted' AND date_registered='$date'";
                                                                ...
                                                                ?><td><?php echo $status_month_1_3_stunted; ?></td><?php
                                                                                                                }
                                                                                                                    ?>< !-- End Query for status_month_1_3-stunted --><?php
                                                                                                                                                                        $query = "SELECT count(*) FROM target_childcare_male 
                WHERE status_month_6_11='stunted' AND date_registered='$date'";
                                                                                                                                                                        ...
                                                                                                                                                                        ?><td><?php echo $status_month_6_11_stunted; ?></td><?php
                                                                                                                                                                                                                        }
                                                                                                                                                                                                                            ?>< !-- End Query for status_month_6_11-stunted --><?php
                                                                                                                                                                                                                                                                                $query = "SELECT count(*) FROM target_childcare_male 
                WHERE status_month_12='stunted' AND date_registered='$date'";
                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                ?><td><?php echo $status_month_12_stunted; ?></td><?php
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                }
                ...
                WHERE status_month_1_3='wasted' AND date_registered='$date'";
                                                                ...
                                                                ?><td><?php echo $status_month_1_3_wasted; ?></td><?php
                                                                                                                }
                                                                                                                    ?>< !-- End Query for status_month_1_3-wasted --><?php
                                                                                                                                                                        $query = "SELECT count(*) FROM target_childcare_male 
                WHERE status_month_6_11='wasted' AND date_registered='$date'";
                                                                                                                                                                        ...
                                                                                                                                                                        ?><td><?php echo $status_month_6_11_wasted; ?></td><?php
                                                                                                                                                                                                                        }
                                                                                                                                                                                                                            ?>< !-- End Query for status_month_6_11-wasted --><?php
                                                                                                                                                                                                                                                                                $query = "SELECT count(*) FROM target_childcare_male 
                WHERE status_month_12='wasted' AND date_registered='$date'";
                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                ?><td><?php echo $status_month_12_wasted; ?></td><?php
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                }
                ...
                WHERE status_month_1_3='obese/overweight' AND date_registered='$date'";
                                                                ...
                                                                ?><td><?php echo $status_month_1_3_obese_overweight; ?></td><?php
                                                                                                                        }
                                                                                                                            ?>< !-- End Query for status_month_1_3-obese/overweight --><?php
                                                                                                                                                                                        $query = "SELECT count(*) FROM target_childcare_male 
                WHERE status_month_6_11='obese/overweight' AND date_registered='$date'";
                                                                                                                                                                                        ...
                                                                                                                                                                                        ?><td><?php echo $status_month_6_11_obese_overweight; ?></td><?php
                                                                                                                                                                                                                                                    }
                                                                                                                                                                                                                                                        ?>< !-- End Query for status_month_6_11-obese/overweight --><?php
                                                                                                                                                                                                                                                                                                                    $query = "SELECT count(*) FROM target_childcare_male 
                WHERE status_month_12='obese/overweight' AND date_registered='$date'";
                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                    ?><td><?php echo $status_month_12_obese_overweight; ?></td><?php
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        }
                ...
                WHERE status_month_1_3='normal' AND date_registered='$date'";
                                                                ...
                                                                ?><td><?php echo $status_month_1_3_normal; ?></td><?php
                                                                                                                }
                                                                                                                    ?>< !-- End Query for status_month_1_3-normal --><?php
                                                                                                                                                                        $query = "SELECT count(*) FROM target_childcare_male 
                WHERE status_month_6_11='normal' AND date_registered='$date'";
                                                                                                                                                                        ...
                                                                                                                                                                        ?><td><?php echo $status_month_6_11_normal; ?></td><?php
                                                                                                                                                                                                                        }
                                                                                                                                                                                                                            ?>< !-- End Query for status_month_6_11-normal --><?php
                                                                                                                                                                                                                                                                                $query = "SELECT count(*) FROM target_childcare_male 
                WHERE status_month_12='normal' AND date_registered='$date'";
                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                ?><td><?php echo $status_month_12_normal; ?></td><?php
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    }
