<div id="postnatal__report<?= $patient['postnatal_id'] ?>" class="modal prenatal__report">
    ...
    <a target="_blank" href="./includes/print_pdf.php?id=<?=$patient['postnatal_id']?>&&label=<?=$patient['label']?>" class="btn btn-sm btn-primary"> Print  Details</a>
</div>
...
?>
    ...
    <div class="modal deworming-reports" id="postnatal-daily-reports">
        ...
        ?>
            <p class="deworming-reports__male">
                Total No. of Patient Age 22-29 y/o: <?php echo $row['count(*)']; ?>
            </p>
        <?php
        }
        ?>
