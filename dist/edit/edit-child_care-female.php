            ...
            <form action="../includes/edit_query.php" method='POST' class="edit-child_care-female__form"> <!--form action and method added-->
                ...
                ?>
                        ...
                        <div class="edit-child_care-female__form-item">
                            ...
                            <input type="number" name="child_care-female-newborn-length" id="child_care-male-newborn-length" value="<?= $patient['length_newborn']; ?>">
                        </div>
                        <div class="edit-child_care-female__form-item">
                            <label for="child_care-male--newbornweight">Weight at Birth * <br>(kg)</label>
                            <input type="number" name="child_care-female-newborn-weight" id="child_care-male-newborn-weight" value="<?= $patient['weight_newborn']; ?>" required>
                        </div>
                        <div class="edit-child_care-female__form-item edit-child_care-female__form-item--radio">
                        ...
                        <div class="edit-child_care-female__form-item">
                            ...
                            <div class="two-input">
                                <div class="two-input__item">
                                    <input type="number" name="child_care-female-1mos-length-cm" id="child_care-male-1mos-length-cm" value="<?= $patient['length_month_1_3']; ?>">
                        ...
                        <div class="edit-child_care-female__form-item">
                            ...
                            <div class="two-input">
                                <div class="two-input__item">
                                    <input type="number" name="child_care-female-1mos-weight-kg" id="child_care-male-1mos-weight-kg" value="<?= $patient['weight_month_1_3']; ?>">
                        ...
                        <div class="edit-child_care-female__form-item">
                            ...
                            <div class="two-input">
                                <div class="two-input__item">
                                    <input type="number" name="child_care-female-6mos-length-cm" id="child_care-male-6mos-length-cm" value="<?= $patient['length_month_6_11']; ?>">
                                    <label for="child_care-male-length-cm">cm</label>
                                </div>
                                <div class="two-input__item">
                        ...
                        <div class="edit-child_care-female__form-item">
                            ...
                            <div class="two-input">
                                <div class="two-input__item">
                                    <input type="number" name="child_care-female-6mos-weight-kg" id="child_care-male-6mos-weight-kg" value="<?= $patient['weight_month_6_11']; ?>">
                                    <label for="child_care-male-weight-kg">kg</label>
                                </div>
                                <div class="two-input__item">
                        ...
                        <div class="edit-child_care-female__form-item">
                            ...
                            <div class="two-input">
                                <div class="two-input__item">
                                    <input type="number" name="child_care-female-12mos-length-cm" id="child_care-male-12mos-length-cm" value="<?= $patient['length_month_12']; ?>">
                                    <label for="child_care-male-length-cm">cm</label>
                                </div>
                                <div class="two-input__item">
                        ...
                        <div class="edit-child_care-female__form-item">
                            ...
                            <div class="two-input">
                                <div class="two-input__item">
                                    <input type="number" name="child_care-female-12mos-weight-kg" id="child_care-male-12mos-weight-kg" value="<?= $patient['weight_month_12']; ?>">
                                    <label for="child_care-male-weight-kg">kg</label>
                                </div>
                                <div class="two-input__item">
