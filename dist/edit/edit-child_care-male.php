            ...
            <form action="../includes/edit_query.php" method='POST' class="edit-child_care-male__form"> <!--form action and method added-->
                ...
                ?>
                        ...
                        <div class="edit-child_care-male__form-item">
                            ...
                            <input type="date" name="child_care-male-registration" id="child_care-male-registration" value="<?= $patient['date_registered']; ?>" required>
                        </div>
                        <div class="edit-child_care-male__form-item">
                            <label for="child_care-male-birthdate">Date of Birthdate *</label>
                            <input type="date" name="child_care-male-birthdate" id="child_care-male-birthdate" value="<?= $patient['birthday']; ?>" required>
                        </div>
                        <div class="edit-child_care-male__form-item">
                            <label for="child_care-male-family-serial">Family Serial No. *</label>
                            <input type="text" name="child_care-male-family-serial" id="child_care-male-family-serial" value="<?= $patient['serial']; ?>" required>
                        </div>
                        ...
                        <div class="edit-child_care-male__form-item">
                            ...
                            <div class="three-input">
                                <div class="three-input__item">
                                    <input type="text" name="child_care-male-first-name" id="child_care-male-first-name" value="<?= $patient['child_firstname']; ?>" required>
                                ...
                                <div class="three-input__item">
                                    <input type="text" name="child_care-male-last-name" id="child_care-male-last-name" value="<?= $patient['child_lastname']; ?>" required>
                    ...
                    <div class="edit-user__form--role-item">
                        ...
                        <div class="edit-child_care-male__form-item">
                            ...
                            <div class="three-input">
                                <div class="three-input__item">
                                    <input type="text" name="child_care-male-mother-first-name" id="child_care-male-mother-first-name" value="<?= $patient['mother_firstname']; ?>" required>
                                    <label for="child_care-male-first-name">First Name *</label>
                                </div>
                                <div class="three-input__item">
                                ...
                                <div class="three-input__item">
                                    <input type="text" name="child_care-male-mother-last-name" id="child_care-male-last-name" value="<?= $patient['mother_lastname']; ?>" required>
                                    <label for="child_care-male-last-name">Last Name *</label>
                                </div>
                            </div>
                        </div>
                        <div class="edit-child_care-male__form-item">
                            ...
                            <textarea name="child_care-male-address" id="child_care-male-address" cols="27" rows="5" required><?= $patient['complete_address']; ?></textarea>
                        </div>
                        ...
                        <div class="edit-child_care-male__form-item edit-child_care-male__form-item--radio">
                            ...
                            <div class="edit-user__form--role-item">
                                <div class="edit-user__form-item">
                                    <input type="radio" name="child_care-male--cpab" id="child_care-male--tt2" value="TT2/Td2 given a month prior to delivery" <?= ($patient['cpab'] == 'TT2/Td2 given a month prior to delivery') ? 'checked' : '' ?> required>
                                    <label for="child_care-male--tt2">TT2/Td2 given a month prior to delivery</label>
                                </div>
                                <div class="edit-user__form-item">
                                    <input type="radio" name="child_care-male--cpab" id="child_care-male--tt3" value="TT3/Td3 to TT5/Td5 (TT1/Td1 TT5/Td5) given any time prior to delivery" <?= ($patient['cpab'] == 'TT3/Td3 to TT5/Td5 (TT1/Td1 TT5/Td5) given any time prior to delivery') ? 'checked' : '' ?> required>
                        ...
                        <div class="edit-child_care-male__form-item">
                            ...
                            <input type="tel" name="child_care-male-newborn-weight" id="child_care-male-newborn-weight" value="<?= $patient['weight_newborn']; ?>" required>
                        </div>
                        <div class="edit-child_care-male__form-item edit-child_care-male__form-item--radio">
                            <label for="child_care-male-newborn-weight">Status(Birth Weight) *<br>(kg)</label>
                            <div class="edit-user__form--role-item">
                                <div class="edit-user__form-item">
                                    <input type="radio" name="child_care-male-newborn-weight-status" id="child_care-male-newborn-weight-low" value="low: < 2500gms" <?= ($patient['status_newborn'] == 'low: < 2500gms') ? 'checked' : '' ?> required>
                                    <label for="child_care-male-newborn-weight-low">L: low: < 2500gms </label>
                                </div>
                                <div class="edit-user__form-item">
                                    <input type="radio" name="child_care-male-newborn-weight-status" id="child_care-male-newborn-weight-normal" value="normal: >= 2500gms" <?= ($patient['status_newborn'] == 'normal: >= 2500gms') ? 'checked' : '' ?> required>
                                    <label for="child_care-male-newborn-weight-normal">N:normal: >= 2500gms </label>
                                </div>
                                <div class="edit-user__form-item">
                                    <input type="radio" name="child_care-male-newborn-weight-status" id="child_care-male-newborn-weight-unknown" value="unknown" <?= ($patient['status_newborn'] == 'unknown') ? 'checked' : '' ?> required>
