                ...
                <form action="../includes/edit_query.php" method='POST' class="edit-bhw__form">
                    ...
                    ?>
                            ...
                            <div class="edit-bhw__form-item">
                                ...
                                <div class="password">
                                    <input type="password" class="password__bar__input" id="bhw-new-password" min="8" name="bhw-new-password" placeholder="Enter your password" required /><!--  
                        --><button type="button" class="password__bar__btn" onclick="passwordToggle('bhw-new-password' , 'password-show-p' , 'password-hide-p')">
                            ...
                            <div class="edit-bhw__form-item">
                                ...
                                <div class="password">
                                    <input type="password" class="password__bar__input" id="bhw-confirm-new-password" min="8" name="bhw-confirm-new-password" placeholder="Confirm your password" required /><!--  
