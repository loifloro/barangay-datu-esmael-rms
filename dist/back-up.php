...
<body class="grid">
    ...
    <header class="navbar">
        <nav class="navigation">
            ...
            <input type="text" 
                    ...
                    placeholder="Search backup last name"> 
    ...
    <main class="backup">
        <section class="backup">
            <h2 class="backup__title">
                Services
            </h2>
            <ul class="backup__services" role="list">
                <li class="backup__services__item backup__services__item--active">
                    Deworming
                </li>
                <li class="backup__services__item">
                    Consultation
                </li>
                <li class="backup__services__item">
                    Prenatal
