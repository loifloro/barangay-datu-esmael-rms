        ...
        <section class="reports">
            <form action="" class="reports__form" method="GET">
                ...
                <div class="reports__card">
                    ...
                    <?php
                        //DEFAULT DISPLAY
                        $query = "SELECT count(*) FROM postnatal WHERE archive_label='' AND age>=17 AND age<=21";
                        $result = mysqli_query($conn, $query);
                        
                        //CONDITION IF SORT BUTTON IS CLICKED
                        if(isset($_GET['sort__date'])){
                            $date= mysqli_real_escape_string($conn, $_GET['report__date']);
                            $query = "SELECT count(*) FROM postnatal WHERE archive_label='' AND age>=17 AND age<=21 AND postnatal_date='$date'";
                            $result = mysqli_query($conn, $query);
                        }
                    ...
                    <?php
                        ...
                        if(isset($_GET['sort__date'])){
                            $date= mysqli_real_escape_string($conn, $_GET['report__date']);
                            $query = "SELECT count(*) FROM postnatal WHERE archive_label='' AND age>=22 AND age<=29 AND postnatal_date='$date'";
                            $result = mysqli_query($conn, $query);
                        }
